...
tforward = 0:0.1:170;
 ...
 k = [46083.0686392091,0.161003028125379,1.07778443294132e-08,...
     ...
     5.26530143560413e-10,0.00277981294517048,0.1]; 

%k = [33142.4532711595,0.107913348286809,3.12455306544541e-07,0.339704937940966,3003.56201501625,61.1179519875886,0.000254081179652788,5.19143971997416e-05,5145.49378278900,403.872533569157,7.88165331292409e-12,0.432285869539316,4.16510186819335e-06,0.000102125083760112,534.819752649024,2.61288595426876e-08,77.9928404012232,0.0146991810164805];    
lb = zeros(1,length(k));
...
dy(1) = r - (rho_0/(1 + A_1*A))*T*V - d*T;
dy(2) = (rho_0/(1 + A_1*A))*T*V - delta*T_i - psi_01*T_i*Z;
