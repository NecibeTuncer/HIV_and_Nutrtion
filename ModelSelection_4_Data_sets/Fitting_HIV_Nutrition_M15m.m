...
k = [45886.5053638243,0.160132710685387,1.08486439044879e-08,...
        0.890838584826533,2841.45587896300,10.1252140103067,...
        2.32401569046167e-07,5.49039541007905e-08,0.194388579298720,...
        49.1263950786075,9.74402219908321e-09,2.91257556425399,...
        1.90405185542877,2.46206973216690e-09,0.224651727531468,...
        6.03496953525374e-10,0.00237164317206143, 0.1, 0.1];
...
dy(2) = (rho_0/(1 + A_1*A + A_2*G))*T*V - delta*T_i - (psi_02*G)/(psi + A + G)*T_i*Z;
