...
tforward = 0:0.1:170;
 ...
 k = [46083.0686392091,0.161003028125379,1.07778443294132e-08,...
     ...
     5.26530143560413e-10,0.00277981294517048,3, 0.1,3.30502074055700e-07 ];
...
display('Parameters after data fitting Model 8:')
...
dy(2) = (rho_0/(1+A_1*A))*T*V - delta*T_i - (psi_02*(psi_01*A + G))/(psi + A + G)*T_i*Z;;
