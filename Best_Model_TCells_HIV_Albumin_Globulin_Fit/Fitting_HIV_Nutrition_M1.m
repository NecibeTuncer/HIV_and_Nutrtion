...
k = [46083.0686392091,0.161003028125379,1.07778443294132e-08,0.896700363149943,2826.05378877325,9.92963416295260,3.30502074055700e-07,8.11958539446260e-08,0.280043973070943,7.67667183288055,1.41187037459318e-08,2.33137194222245,0.999792374260813,3.17704811206496e-09,0.377457207980577,5.26530143560413e-10,0.00277981294517048]; 
 %results in paper
 %k = [45886.5053638243,0.160132710685387,1.08486439044879e-08,0.890838584826533,2841.45587896300,10.1252140103067,2.32401569046167e-07,5.49039541007905e-08,0.194388579298720,49.1263950786075,9.74402219908321e-09,2.91257556425399,1.90405185542877,2.46206973216690e-09,0.224651727531468,6.03496953525374e-10,0.00237164317206143]
...
hold on 
plot(tVLdata, ViralData, 'o', 'color', 'k', 'MarkerSize', 8)
...
hold on 
plot(tVLdata, log10(ViralData), 'o', 'color', 'k', 'MarkerSize', 8)
...
hold on 
plot(tCD4data, CD4Data, 'o', 'color', 'k', 'MarkerSize', 8)
...
hold on 
plot(tCD4data, log10(CD4Data), 'o', 'color', 'k', 'MarkerSize', 8)
...
figure(5)
plot(tforward, y_r(:,4),'-b','LineWidth',2, 'color', 'k')
hold on
...
hold on
plot(tAlbumindata, AlbuminData, 'o', 'color', 'k', 'MarkerSize', 8)
...
hold on
plot(tGlobulindata, GlobulinData, 'o', 'color', 'k', 'MarkerSize', 8)
title('Globulin Concentration', 'fontweight', 'normal', 'fontsize', 18)
xlabel('Time in Days', 'fontweight', 'normal', 'fontsize', 18)
ylabel('Globulin Concentration', 'fontweight', 'normal', 'fontsize', 18) %what are units?
set(gca, 'YGrid', 'on', 'XGrid', 'off','LineWidth', 2,'fontsize',14)
